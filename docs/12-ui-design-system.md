...
- Light, Dark, and System themes are approved for authenticated Settings. Dark
  ...
  palette.
- Light follows the approved Calm Financial direction: a cool off-white canvas,
  white primary surfaces, neutral blue-gray separation, deep neutral text, and
  desaturated ink-blue interaction emphasis. Neutral structure dominates;
  accent color is functional rather than decorative. Financial status colors
  remain independent.
