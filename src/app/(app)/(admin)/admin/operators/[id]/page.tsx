...
export default async function OperatorDetailPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ error?: string; notice?: string }> }) {
  ...
  return <ContentWrapper>
    <SectionHeader title={operator.name} description="Profil akun Operator. Halaman ini tidak memuat informasi keuangan." action={<Link className={styles.link} href="/admin/operators"><ArrowLeft size={16} /> Kembali</Link>} />
